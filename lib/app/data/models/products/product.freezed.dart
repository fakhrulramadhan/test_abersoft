...
abstract class $ProductCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int? id, String? name, String? imageUrl, String? productDescription});
}
...
class _$_Product implements _Product {
  _$_Product({this.id, this.name, this.imageUrl, this.productDescription});
...
abstract class _Product implements Product {
  factory _Product(
      ...
      final String? name,
      final String? imageUrl,
      final String? productDescription}) = _$_Product;
